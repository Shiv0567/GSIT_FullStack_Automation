...

{
	...
	public void testSearchProduct(String keyword)
	{
		 ...
		 logger.info("TESTCASE 9 SEARCH PRODUCT PAGE");
		    ...
		    Assert.assertTrue(productPage.isProductPageUrl() && productPage.isProductTitle(),  "Expected Products Page to be visible but it is not.");
		    ...
		    {
		    	softassert.assertTrue(product.toLowerCase().contains(keyword.toLowerCase()),
